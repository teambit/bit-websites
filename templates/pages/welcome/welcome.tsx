...
import { Card } from '@company/scope.templates.ui.card';
import { Heading } from '@company/scope.templates.ui.heading';
import { Text } from '@company/scope.templates.ui.text';
